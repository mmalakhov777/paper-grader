...
const PlagiarismBenefitsESMX: React.FC = () => {
  return (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 max-w-[1240px] mx-auto">
          ...
          <FeatureItem
            ...
            description="Revisa plagio y contenido generado por IA con nuestro sistema de detección de doble propósito"
          />
          <FeatureItem
            icon={<DetailedFeedbackIcon className="w-6 h-6 md:w-8 md:h-8" />}
            title="Integración con Turnitin"
            description="Revisa el plagio con compatibilidad Turnitin para verificación de integridad académica"
          />
          <FeatureItem
...
export default PlagiarismBenefitsESMX; 