...
const PlagiarismHeroESMX: React.FC = () => {
  return (
        ...
        <div className="text-center mx-auto">
          ...
          <div className="inline-flex items-center gap-2 mb-6 md:mb-8 border border-[#E8E8E5] rounded-full px-4 py-2">
            ...
            <div className="text-sm md:text-base text-[#232323] font-aeonik">
              <span className="font-normal">Lo aman </span>
          ...
          <h1 className="text-[2rem] sm:text-[3rem] md:text-[3.5rem] lg:text-[5rem] leading-[1.1] sm:leading-[1.2] md:leading-[1.2] font-orbikular mb-4 md:mb-8 text-[#232323]">
            <span className="inline-block">
              <em className="not-italic font-orbikular" style={{ fontVariationSettings: "'wght' 500" }}>Detecta</em>
              <span className="inline-block mx-2">y</span>
              <em className="not-italic font-orbikular" style={{ fontVariationSettings: "'wght' 500" }}>Corrige</em>
            </span>
            <br />
            <span className="inline-block">Plagio al Instante</span>
          </h1>
          <p className="font-['Aeonik Pro'] text-base sm:text-lg md:text-xl mb-6 md:mb-12 text-gray-600">
            Herramienta avanzada para detectar plagio y contenido duplicado. Obtén resultados inmediatos y precisos para asegurar que tu texto sea original.
          </p>
...
export default PlagiarismHeroESMX; 