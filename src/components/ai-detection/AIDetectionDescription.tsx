...
const AIDetectionDescription: React.FC = () => {
  const benefits = [
    {
      icon: <Shield className="w-6 h-6 text-[#232323]" />,
      title: "AI Detection Checker",
      description: "Advanced AI detection software with real-time content analysis and verification capabilities"
    },
    {
      icon: <Search className="w-6 h-6 text-[#232323]" />,
      title: "AI Detection Website",
      description: "Professional AI detection site with advanced scanning features and instant results"
    },
    {
      icon: <FileCheck className="w-6 h-6 text-[#232323]" />,
      title: "AI Content Detection",
      description: "Comprehensive AI content detection tools to identify AI-generated text with high accuracy"
    },
    {
      icon: <AlertCircle className="w-6 h-6 text-[#232323]" />,
      title: "AI Detection Remove",
      description: "Advanced tools to help avoid AI detection and improve content authenticity"
    }
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-[2rem] md:text-[3.25rem] font-medium leading-[1.2] md:leading-[3.75rem] mb-12 text-center text-[#232323]">
            The Ultimate AI Detection Technology
          </h2>
...
export default AIDetectionDescription; 