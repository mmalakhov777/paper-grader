        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-24 items-start max-w-[1200px] mx-auto">
          ...
          <div className="relative">
            ...
            <div className="bg-white rounded-[20px] p-6 lg:p-8 shadow-sm border border-gray-100 relative z-10 mb-[-48px] lg:mb-0">
              ...
              <p className="text-[#9CA3AF] leading-relaxed text-base font-normal">
                As redes sociais têm um forte impacto sobre os adolescentes. Elas afetam sua saúde mental, autoestima e comportamento. Muitos adolescentes passam horas online todos os dias, o que pode levar à ansiedade e sono ruim. No geral, as redes sociais moldam como os jovens veem a si mesmos e o mundo ao seu redor.
              </p>
            </div>
            ...
            <div className="bg-white rounded-[20px] p-6 lg:p-8 shadow-sm border border-gray-100 relative lg:absolute lg:top-[160px] lg:left-[40px] lg:right-[-40px] z-20">
              ...
              <p className="text-[#3C3C3C] leading-relaxed text-base font-normal">
                As redes sociais têm um forte impacto sobre os adolescentes. Elas afetam sua saúde mental, autoestima e comportamento. <span className="bg-[#60A5FA]/20 rounded-[4px]">De acordo com um estudo recente, o uso excessivo diário está associado ao aumento da ansiedade e distúrbios do padrão de sono</span> <span className="text-[#60A5FA]">(Silva & Santos, 2021)</span>. No geral, as redes sociais moldam como os jovens veem a si mesmos e o mundo ao seu redor.
              </p>
            </div>
          </div>
          ...
          <div className="lg:pl-16 mt-6 lg:mt-0">
            <h2 className="text-[2rem] lg:text-[3.25rem] font-medium leading-[1.2] lg:leading-[3.75rem] mb-6 lg:mb-8 text-[#232323]">
              Melhore seu trabalho com citações em linha
            </h2>
            
            <div className="space-y-2 lg:space-y-[8px] mb-8">
              <div className="flex items-center gap-3">
                <Check className="w-5 h-5 lg:w-6 lg:h-6 text-[#232323]" />
                <span className="text-base lg:text-xl text-[#232323] font-medium">Identifique afirmações sem citação instantaneamente</span>
              </div>
              <div className="flex items-center gap-3">
                <Check className="w-5 h-5 lg:w-6 lg:h-6 text-[#232323]" />
                <span className="text-base lg:text-xl text-[#232323] font-medium">Insira fontes confiáveis em linha com um clique</span>
              </div>
              <div className="flex items-center gap-3">
                <Check className="w-5 h-5 lg:w-6 lg:h-6 text-[#232323]" />
                <span className="text-base lg:text-xl text-[#232323] font-medium">Torne seus argumentos mais credíveis</span>
              </div>
            </div>
