...
const ProofreadingBenefits: React.FC = () => {
  return (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 max-w-[1240px] mx-auto">
          <FeatureItem
            ...
            description="Professional proofreading and editing services for academic papers and essays"
          />
          <FeatureItem
            icon={<CheckCircle className="w-6 h-6 md:w-8 md:h-8" />}
            title="AI Proofreading"
            description="Advanced AI-powered proofreading tools with instant feedback and suggestions"
          />
          <FeatureItem
            icon={<BookOpen className="w-6 h-6 md:w-8 md:h-8" />}
            title="Academic Editing"
            description="Specialized thesis editing services and manuscript editing for researchers"
          />
          <FeatureItem
            icon={<Clock className="w-6 h-6 md:w-8 md:h-8" />}
            title="24/7 Service"
            description="Professional proofreader online assistance available around the clock"
          />
        </div>
      </div>
    </section>
...
export default ProofreadingBenefits; 