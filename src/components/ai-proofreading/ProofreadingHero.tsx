...
const ProofreadingHero: React.FC = () => {
  return (
        ...
        <div className="text-center mx-auto">
          ...
          <h1 className="text-[2rem] sm:text-[3rem] md:text-[3.5rem] lg:text-[5rem] leading-[1.1] sm:leading-[1.2] md:leading-[1.2] font-orbikular mb-4 md:mb-8 text-[#232323]">
            <span className="inline-block">
              <em className="not-italic font-orbikular" style={{ fontVariationSettings: "'wght' 500" }}>Perfect</em>
              <span className="inline-block mx-2">your</span>
              <em className="not-italic font-orbikular" style={{ fontVariationSettings: "'wght' 500" }}>Writing</em>
            </span>
            <br />
            <span className="inline-block">With AI Proofreading</span>
          </h1>
...
export default ProofreadingHero; 