...
const PlagiarismFeaturesPT: React.FC = () => {
  const features = [
    {
      icon: <Shield className="w-6 h-6 text-[#232323]" />,
      title: "Detecção Avançada de Plágio",
      description: "Sistema abrangente de detecção de plágio alimentado por tecnologia de IA.",
      benefits: [
        "Detecte plágio e texto de IA com algoritmos avançados",
        "Descubra plágio em trabalhos acadêmicos",
        "Digitalização em tempo real e resultados instantâneos",
    ...
    },
    {
      ...
      benefits: [
        ...
        "Relatórios abrangentes de plágio"
      ]
    },
    {
      ...
      benefits: [
        ...
        "Verifique submissões de estudantes",
        "Identifique potencial plágio",
    ...
    },
    {
      ...
      benefits: [
        ...
        "Obtenha dicas sobre originalidade de conteúdo",
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-lg md:text-xl text-[#666666] font-aeonik max-w-3xl mx-auto">
              Ferramentas avançadas para detecção abrangente de plágio e verificação de conteúdo
            </p>
          </div>
...
export default PlagiarismFeaturesPT; 