...
const PlagiarismBenefitsPT: React.FC = () => {
  return (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 max-w-[1240px] mx-auto">
          <FeatureItem
            ...
            title="Procure por Plágio"
            description="Scanner avançado de plágio com capacidades de detecção de IA para análise abrangente de conteúdo"
          />
          <FeatureItem
            icon={<InTextCitationsIcon className="w-6 h-6 md:w-8 md:h-8" />}
            title="Detecção de Texto de IA"
            description="Verifique plágio e conteúdo gerado por IA com nosso sistema de detecção de duplo propósito"
          />
          <FeatureItem
...
export default PlagiarismBenefitsPT; 