...
const AIDetectionComparisonES: React.FC = () => {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-24 items-start max-w-[1200px] mx-auto">
          ...
          <div className="relative">
            ...
            <div className="bg-white rounded-[20px] p-6 lg:p-8 shadow-sm border border-gray-100 relative z-10 mb-[-48px] lg:mb-0">
              ...
              <p className="text-[#9CA3AF] leading-relaxed text-base font-normal font-aeonik">
                El ensayo analiza el cambio climático y sus efectos en los ecosistemas globales. El aumento de las temperaturas está causando cambios significativos en los patrones climáticos y afectando a las poblaciones de vida silvestre en todo el mundo. Estos cambios están provocando diversos desafíos ambientales que requieren atención inmediata.
              </p>
            </div>
          ...
          <div className="lg:pl-16 mt-6 lg:mt-0">
            <h2 className="text-[2rem] lg:text-[3.25rem] font-medium leading-[1.2] lg:leading-[3.75rem] mb-6 lg:mb-8 text-[#232323]">
              Detecta Contenido Generado por IA Instantáneamente
            </h2>
            ...
            <div className="space-y-2 lg:space-y-[8px] mb-8">
              ...
              <div className="flex items-center gap-3">
                <Check className="w-5 h-5 lg:w-6 lg:h-6 text-[#232323]" />
                <span className="text-base lg:text-xl text-[#232323] font-medium font-aeonik">Soluciona problemas de detección de IA al instante</span>
              </div>
              <div className="flex items-center gap-3">
                <Check className="w-5 h-5 lg:w-6 lg:h-6 text-[#232323]" />
...
export default AIDetectionComparisonES; 