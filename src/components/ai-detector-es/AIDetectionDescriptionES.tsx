...
const AIDetectionDescriptionES: React.FC = () => {
  const benefits = [
    {
      icon: <Shield className="w-6 h-6 text-[#232323]" />,
      title: "Verificador de Detección de IA",
      description: "Software avanzado de detección de IA con análisis de contenido en tiempo real y capacidades de verificación"
    },
    {
      icon: <Search className="w-6 h-6 text-[#232323]" />,
      title: "Sitio Web de Detección de IA",
      description: "Sitio profesional de detección de IA con funciones avanzadas de escaneo y resultados instantáneos"
    },
    {
      icon: <FileCheck className="w-6 h-6 text-[#232323]" />,
      title: "Detección de Contenido IA",
      description: "Herramientas integrales de detección de contenido de IA para identificar texto generado por IA con alta precisión"
    },
    {
      icon: <AlertCircle className="w-6 h-6 text-[#232323]" />,
      title: "Eliminación de Detección de IA",
      description: "Herramientas avanzadas para ayudar a evitar la detección de IA y mejorar la autenticidad del contenido"
    }
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-[2rem] md:text-[3.25rem] font-medium leading-[1.2] md:leading-[3.75rem] mb-12 text-center text-[#232323]">
            La Tecnología Definitiva de Detección de IA
          </h2>
          ...
          <div className="mt-12 text-center">
            <a href="https://mystylus.ai/paper-grader/" className="no-underline">
              <button className="bg-[#232323] text-white py-4 px-8 rounded-full text-lg font-medium hover:bg-[#3C3C3C] transition-colors duration-300">
                Prueba la Detección de IA Ahora
              </button>
            </a>
          </div>
        </div>
...
export default AIDetectionDescriptionES; 