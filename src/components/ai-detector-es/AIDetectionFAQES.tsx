...
const AIDetectionFAQES: React.FC = () => {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "Sí, nuestra herramienta de detección de IA puede analizar tu texto y proporcionar información detallada sobre su autenticidad y posible contenido generado por IA."
    },
    {
    ...
    {
      question: "¿Es realmente útil esta herramienta?",
      answer: "Sí, nuestra herramienta proporciona una detección precisa y confiable de contenido de IA, ayudando a los usuarios a mantener la autenticidad del contenido y la integridad académica."
    }
  ];
...
export default AIDetectionFAQES; 