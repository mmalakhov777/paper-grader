...
const AIDetectionFeaturesES: React.FC = () => {
  const features = [
    {
      icon: <Shield className="w-6 h-6 text-[#232323]" />,
      title: "Herramientas de Detección de IA para Profesores",
      ...
      benefits: [
        ...
        "Detección de IA para comprobaciones de plagio",
...
export default AIDetectionFeaturesES; 