...
const ProofreadingBenefitsPTBR: React.FC = () => {
  return (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 max-w-[1240px] mx-auto">
          <FeatureItem
            ...
            description="Serviços profissionais de revisão e edição para trabalhos acadêmicos e ensaios"
          />
          <FeatureItem
          ...
          <FeatureItem
            ...
            title="Edição Acadêmica"
            description="Serviços especializados de edição de teses e manuscritos para pesquisadores"
          />
          <FeatureItem
...
export default ProofreadingBenefitsPTBR; 