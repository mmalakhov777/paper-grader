...
const ProofreadingDescriptionPTBR: React.FC = () => {
  const benefits = [
    {
      icon: <FileEdit className="w-6 h-6 text-[#232323]" />,
      title: "Revisão e Edição em Português",
      description: "Serviços profissionais de revisão e edição para trabalhos acadêmicos, ensaios e manuscritos"
    },
    {
    ...
    },
    {
      ...
      title: "Serviços de Revisão Acadêmica",
      description: "Serviços especializados de edição de teses e edição de manuscritos para pesquisadores"
    },
    {
...
export default ProofreadingDescriptionPTBR; 