...
const AIDetectionHeroPT: React.FC = () => {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mx-auto">
          ...
          <p className="font-['Aeonik Pro'] text-base sm:text-lg md:text-xl mb-6 md:mb-12 text-gray-600">
            Ferramenta avançada para detectar conteúdo gerado por IA. Obtenha resultados instantâneos e precisos para verificar a autenticidade do seu texto.
          </p>
...
export default AIDetectionHeroPT; 