...
const AIDetectionFAQPT: React.FC = () => {
  ...
  const faqItems = [
    {
      ...
      answer: "É uma ferramenta online que ajuda os usuários a identificar se um texto foi gerado por inteligência artificial. Um detector de IA é útil para verificar a autenticidade de diversos textos, incluindo redações, artigos, trabalhos de pesquisa, relatórios e blogs."
    },
    {
...
export default AIDetectionFAQPT; 