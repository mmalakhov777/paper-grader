...
const AIDetectionBenefitsPT: React.FC = () => {
  return (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 max-w-[1240px] mx-auto">
          ...
          <FeatureItem
            ...
            title="Ferramentas para Redações"
            description="Detecção de IA no Turnitin, detecção de plágio e reescrita para evitar detecção"
          />
          <FeatureItem
            icon={<OneClickFixesIcon className="w-6 h-6 md:w-8 md:h-8" />}
            title="Ferramentas Comunitárias"
            description="Ferramenta de paráfrase para evitar detecção de IA e outras soluções recomendadas"
          />
        </div>
      </div>
    </section>
...
export default AIDetectionBenefitsPT; 