...
const PlagiarismDescriptionPTBR: React.FC = () => {
  const benefits = [
    {
      icon: <Shield className="w-6 h-6 text-[#232323]" />,
      title: "Detecção de Plágio com IA",
      description: "Detecção avançada de plágio com tecnologia de IA para verificação completa de conteúdo"
    },
    {
      icon: <Search className="w-6 h-6 text-[#232323]" />,
      title: "Verificação de Plágio e IA",
      description: "Sistema completo de escaneamento para verificar plágio e conteúdo de IA em trabalhos acadêmicos"
    },
    {
...
export default PlagiarismDescriptionPTBR; 