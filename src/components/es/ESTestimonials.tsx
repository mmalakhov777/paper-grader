        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start mb-16">
            ...
            <h2 className="text-[2rem] lg:text-[3.25rem] font-medium leading-[1.2] lg:leading-[3.75rem] mb-12 lg:mb-0 text-left text-[#232323] max-w-[20ch] lg:max-w-none">
              Tus herramientas<br />
              para un trabajo perfecto
            </h2>

            {/* Features */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-12 lg:grid-cols-3 lg:w-[65%] w-full justify-items-start">
              <FeatureItem
                icon={<SmartFeedbackIcon className="w-8 h-8" />}
                title="Retroalimentación inteligente"
                description="Recibe comentarios detallados para cada sección de tu trabajo"
              />
              <FeatureItem
                icon={<OneClickFixesIcon className="w-8 h-8" />}
                title="Buscador de citas"
                description="Mejora tu trabajo con citas académicas en línea"
              />
              <FeatureItem
                icon={<CleanDraftIcon className="w-8 h-8" />}
                title="Correcciones con un clic"
                description="Aplica mejoras instantáneamente, directamente en el editor"
              />
            </div>
          </div>
