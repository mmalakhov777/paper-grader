        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-8 max-w-[1240px] mx-auto">
          ...
          <div className="flex flex-row items-start md:flex-col md:items-center md:text-center gap-3 md:gap-4">
            ...
            <div>
              ...
              <p className="text-[#666666] text-sm">
                Recibe sugerencias sobre estructura, claridad, tono y más
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-row items-start md:flex-col md:items-center md:text-center gap-3 md:gap-4">
            ...
            <div>
              ...
              <p className="text-[#666666] text-sm">
                Asegúrate de que tu trabajo suene como tú — no como ChatGPT
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-row items-start md:flex-col md:items-center md:text-center gap-3 md:gap-4">
            ...
            <div>
              ...
              <p className="text-[#666666] text-sm">
                Detecta contenido copiado y reescríbelo instantáneamente
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-row items-start md:flex-col md:items-center md:text-center gap-3 md:gap-4">
            ...
            <div>
              ...
              <p className="text-[#666666] text-sm">
                Apoya tus argumentos con citas precisas en el texto
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-row items-start md:flex-col md:items-center md:text-center gap-3 md:gap-4">
            ...
            <div>
              <h3 className="text-[15px] md:text-base lg:text-base font-medium mb-1 md:mb-2">Correcciones con Un Clic</h3>
              <p className="text-[#666666] text-sm">
                Aplica sugerencias inteligentes al instante y mejora tu trabajo
              </p>
            </div>
          </div>
        </div>
