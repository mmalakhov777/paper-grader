...
const ParaphrasingFeaturesES: React.FC = () => {
  const features = [
    {
      icon: <Shield className="w-6 h-6 text-[#232323]" />,
      title: "Mejor Herramienta de Parafraseo de IA",
      description: "El mejor parafraseador impulsado por tecnología de IA de vanguardia para transformación natural de texto.",
      benefits: [
        "Parafrasea texto de IA a humano instantáneamente",
        "Mejor herramienta de parafraseo de IA para ensayos",
        "Herramienta de parafraseo que Turnitin no puede detectar",
        "Parafrasea con IA con confianza"
      ]
    },
    {
      ...
      benefits: [
        "Calculadora de parafraseo para precisión",
        "Parafrasea texto en español naturalmente",
        "Herramienta de parafraseo de frases",
    ...
    },
    {
      ...
      description: "Herramientas avanzadas para transformar contenido generado por IA en escritura similar a la humana.",
      benefits: [
        "Cómo parafrasear un texto generado por IA",
        "Parafrasea contenido de IA eficazmente",
        "Mejor IA para parafrasear",
        "Herramienta de parafraseo para ensayos"
      ]
    },
    {
      icon: <RefreshCw className="w-6 h-6 text-[#232323]" />,
      title: "Herramienta de Parafraseo Sin IA",
      description: "Solución completa para transformar y mejorar tu contenido.",
      benefits: [
        "Parafrasea el texto instantáneamente",
        "Características de una buena herramienta de parafraseo",
        "Cómo puedo parafrasear eficazmente",
        "Mejores herramientas de IA para parafrasear"
      ]
    }
  ];
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-[2rem] lg:text-[3.25rem] font-medium leading-[1.2] lg:leading-[3.75rem] mb-6 lg:mb-8 text-center text-[#232323]">
              La Herramienta de Parafraseo de IA Definitiva
            </h2>
            <p className="text-lg md:text-xl text-[#666666] font-aeonik max-w-3xl mx-auto">
              Herramientas avanzadas para transformación y parafraseo integral de texto
            </p>
          </div>
...
export default ParaphrasingFeaturesES; 