...
const ParaphrasingFeaturesPT: React.FC = () => {
  const features = [
    {
      ...
      benefits: [
        ...
        "Ferramenta de paráfrase que o Turnitin não consegue detetar",
    ...
    },
    {
      ...
      benefits: [
        ...
        "Parafraseie texto em português naturalmente",
    ...
    },
    {
      ...
      description: "Solução completa para transformar e melhorar o seu conteúdo.",
      benefits: [
...
export default ParaphrasingFeaturesPT; 