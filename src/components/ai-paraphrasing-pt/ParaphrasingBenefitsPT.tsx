...
const ParaphrasingBenefitsPT: React.FC = () => {
  return (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 max-w-[1240px] mx-auto">
          <FeatureItem
            ...
            description="Ferramenta avançada de paráfrase que não é detetada por IA, perfeita para transformação de conteúdo"
          />
          <FeatureItem
            icon={<InTextCitationsIcon className="w-6 h-6 md:w-8 md:h-8" />}
            title="IA para Texto Humano"
            description="Transforme conteúdo gerado por IA em escrita semelhante à humana com o nosso parafraseador avançado"
          />
          <FeatureItem
            icon={<DetailedFeedbackIcon className="w-6 h-6 md:w-8 md:h-8" />}
            title="Seguro para Turnitin"
            description="Ferramenta de paráfrase que o Turnitin não consegue detetar, garantindo integridade académica"
          />
          <FeatureItem
            icon={<OneClickFixesIcon className="w-6 h-6 md:w-8 md:h-8" />}
            title="Reescrita Inteligente"
            description="A melhor ferramenta de paráfrase de IA para ensaios e conteúdo académico"
          />
        </div>
      </div>
    </section>
...
export default ParaphrasingBenefitsPT; 