...
const AIDetectionFeaturesPTBR: React.FC = () => {
  const features = [
    {
      icon: <Shield className="w-6 h-6 text-[#232323]" />,
      title: "Ferramentas de Detecção de IA para Professores",
      description: "Conjunto completo de ferramentas de detecção de IA projetadas especialmente para profissionais de educação.",
      benefits: [
        "Verificador de detecção de IA para análise de conteúdo",
        "Detecção de IA para checagem de plágio",
        "Recursos de detecção AIGC"
      ]
    },
    {
      icon: <Search className="w-6 h-6 text-[#232323]" />,
      title: "Detecção de Conteúdo IA Online",
      description: "Site profissional de detecção de IA com recursos avançados de escaneamento.",
      benefits: [
        "Integração com sites de detecção de IA",
        "Acesso a portais de detecção de IA",
        "Recursos pra evitar ferramentas de detecção de IA"
      ]
    },
    {
      icon: <FileCheck className="w-6 h-6 text-[#232323]" />,
      title: "Detecção de IA para Trabalhos Acadêmicos",
      description: "Ferramentas especializadas pra verificação e melhoria de trabalhos acadêmicos.",
      benefits: [
        "Recursos pra remover detecção de conteúdo de IA",
        "Software de detecção de IA pra escrita",
        "Remoção de marcadores indesejados de detecção de IA",
        "Conversão de texto de IA pra humano"
      ]
    },
    {
      icon: <RefreshCw className="w-6 h-6 text-[#232323]" />,
      title: "Gestão de Conteúdo de IA",
      description: "Solução completa pra lidar com preocupações sobre conteúdo gerado por IA.",
      benefits: [
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-lg md:text-xl text-[#666666] font-aeonik max-w-3xl mx-auto">
              Ferramentas avançadas pra análise e verificação completa de conteúdo de IA
            </p>
          </div>
...
export default AIDetectionFeaturesPTBR; 