...
const AIDetectionDescriptionPTBR: React.FC = () => {
  const benefits = [
    {
    ...
    },
    {
      ...
      description: "Ferramentas abrangentes de detecção de conteúdo de IA pra identificar texto gerado por IA com alta precisão"
    },
    {
      icon: <AlertCircle className="w-6 h-6 text-[#232323]" />,
      title: "Remover Detecção de IA",
      description: "Ferramentas avançadas pra ajudar a evitar a detecção de IA e melhorar a autenticidade do conteúdo"
    }
  ];
...
export default AIDetectionDescriptionPTBR; 