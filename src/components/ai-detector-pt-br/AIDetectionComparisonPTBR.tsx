...
const AIDetectionComparisonPTBR: React.FC = () => {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-24 items-start max-w-[1200px] mx-auto">
          ...
          <div className="relative">
            ...
            <div className="bg-white rounded-[20px] p-6 lg:p-8 shadow-sm border border-gray-100 relative z-10 mb-[-48px] lg:mb-0">
              ...
              <p className="text-[#9CA3AF] leading-relaxed text-base font-normal font-aeonik">
                O ensaio discute as mudanças climáticas e seus efeitos nos ecossistemas globais. O aumento das temperaturas tá causando mudanças significativas nos padrões climáticos e afetando as populações de vida selvagem em todo o mundo. Essas mudanças tão levando a vários desafios ambientais que precisam de atenção imediata.
              </p>
            </div>
            ...
            <div className="bg-white rounded-[20px] p-6 lg:p-8 shadow-sm border border-gray-100 relative lg:absolute lg:top-[160px] lg:left-[40px] lg:right-[-40px] z-20">
              ...
              <p className="text-[#3C3C3C] leading-relaxed text-base font-normal font-aeonik">
                ...
                • Necessita reescrever pra evitar detecção de IA<br />
                • Recomendado: Use o reescritor de detecção de IA pra melhor originalidade<br />
                • Reescreva pra evitar marcadores de detecção de IA
              </p>
            </div>
          </div>
          ...
          <div className="lg:pl-16 mt-6 lg:mt-0">
            ...
            <div className="space-y-2 lg:space-y-[8px] mb-8">
              ...
              <div className="flex items-center gap-3">
                <Check className="w-5 h-5 lg:w-6 lg:h-6 text-[#232323]" />
                <span className="text-base lg:text-xl text-[#232323] font-medium font-aeonik">Corrija problemas de detecção de IA na hora</span>
              </div>
              <div className="flex items-center gap-3">
                <Check className="w-5 h-5 lg:w-6 lg:h-6 text-[#232323]" />
...
export default AIDetectionComparisonPTBR; 