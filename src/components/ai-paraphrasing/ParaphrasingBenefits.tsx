...
const ParaphrasingBenefits: React.FC = () => {
  return (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 max-w-[1240px] mx-auto">
          <FeatureItem
            ...
            title="Best AI Paraphrasing"
            description="Advanced paraphrasing tool that does not detect AI, perfect for content transformation"
          />
          <FeatureItem
          ...
          <FeatureItem
            ...
            description="Best paraphrasing tool AI for essays and academic content"
          />
        </div>
      </div>
    </section>
...
export default ParaphrasingBenefits; 