...
const ParaphrasingFeatures: React.FC = () => {
  const features = [
    {
      icon: <Shield className="w-6 h-6 text-[#232323]" />,
      title: "Best AI Paraphrasing Tool",
      description: "The best paraphraser powered by cutting-edge AI technology for natural text transformation.",
      benefits: [
        "Paraphrase AI to human text instantly",
        "Best paraphrasing tool AI for essays",
        "Paraphrasing tool that Turnitin cannot detect",
        "AI paraphrase with confidence"
      ]
    },
    {
      icon: <Search className="w-6 h-6 text-[#232323]" />,
      title: "Smart Paraphrasing Bot",
      description: "Professional paraphraser tool with advanced rewriting capabilities.",
      benefits: [
        "Paraphrase calculator for accuracy",
        "Paraphrase English text naturally",
        "Paraphrase sentence tool",
        "Paraphrasing bot for quick results"
      ]
    },
    {
      icon: <FileCheck className="w-6 h-6 text-[#232323]" />,
      title: "AI to Human Paraphrasing",
      description: "Advanced tools for transforming AI-generated content into human-like writing.",
      benefits: [
        "How to paraphrase an AI generated text",
        "Paraphrase AI content effectively",
        "Best AI for paraphrasing",
        "Paraphrasing tool for essays"
      ]
    },
    {
      icon: <RefreshCw className="w-6 h-6 text-[#232323]" />,
      title: "Paraphrasing Tool Without AI",
      description: "Complete solution for transforming and improving your content.",
      benefits: [
        "Paraphrase the text instantly",
        "Good paraphrasing tool features",
        "How can I paraphrase effectively",
        "Best AI tools for paraphrasing"
      ]
    }
  ];
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-[2rem] lg:text-[3.25rem] font-medium leading-[1.2] lg:leading-[3.75rem] mb-6 lg:mb-8 text-center text-[#232323]">
              The Ultimate AI Paraphrase Tool
            </h2>
            <p className="text-lg md:text-xl text-[#666666] font-aeonik max-w-3xl mx-auto">
              Advanced tools for comprehensive text transformation and paraphrasing
            </p>
          </div>
...
export default ParaphrasingFeatures; 