...
const ProofreadingDescriptionESMX: React.FC = () => {
  const benefits = [
    {
    ...
    },
    {
      ...
      description: "Herramientas avanzadas de corrección impulsadas por IA combinadas con experiencia profesional de edición"
    },
    {
...
export default ProofreadingDescriptionESMX; 