...
const ProofreadingFeaturesPT: React.FC = () => {
  const features = [
    {
      icon: <Shield className="w-6 h-6 text-[#232323]" />,
      title: "Revisão de Português Online",
      description: "Serviços profissionais de revisão e edição potenciados pela tecnologia de IA.",
      benefits: [
    ...
    },
    {
      ...
      title: "Serviços de Edição Académica",
      description: "Serviços de edição especializados para documentos académicos e de investigação.",
      benefits: [
        "Serviços de edição de teses e revisão de dissertações",
        "Serviços de edição de manuscritos com revisão especializada",
        "Revisão académica para trabalhos de investigação",
    ...
    },
    {
      ...
      benefits: [
        "Revise o seu ensaio com confiança",
    ...
    },
    {
      ...
      title: "Revisão Alimentada por IA",
      ...
      benefits: [
        ...
        "Revise o seu trabalho com assistência de IA",
...
export default ProofreadingFeaturesPT; 