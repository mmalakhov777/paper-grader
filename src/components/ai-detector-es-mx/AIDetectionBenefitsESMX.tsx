...
const AIDetectionBenefitsESMX: React.FC = () => {
  return (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 max-w-[1240px] mx-auto">
          <FeatureItem
            ...
            title="Mejor Detección de IA"
            description="Herramienta anti-detección de IA y soluciones avanzadas de detección"
          />
          <FeatureItem
            icon={<PlagiarismFixIcon className="w-6 h-6 md:w-8 md:h-8" />}
            title="Herramientas de Detección"
            description="Elimina la detección de IA, IA que evita soluciones de detección de IA"
          />
          <FeatureItem
            icon={<InTextCitationsIcon className="w-6 h-6 md:w-8 md:h-8" />}
            title="Herramientas para Ensayos"
            description="Detección de IA en Turnitin, detección de plagio y reescritura de ensayos para evitar detección"
          />
          <FeatureItem
            icon={<OneClickFixesIcon className="w-6 h-6 md:w-8 md:h-8" />}
            title="Herramientas Comunitarias"
            description="Herramienta de paráfrasis para evitar detección de IA y otras soluciones recomendadas por la comunidad"
          />
        </div>
      </div>
    </section>
...
export default AIDetectionBenefitsESMX; 