...
const ProofreadingFeaturesES: React.FC = () => {
  const features = [
    {
      icon: <Shield className="w-6 h-6 text-[#232323]" />,
      title: "Corrección de Español En Línea",
      description: "Servicios profesionales de corrección y edición potenciados por tecnología de IA.",
      benefits: [
        ...
        "Corrección por IA con resultados instantáneos"
      ]
    },
    {
    ...
    },
    {
      ...
      benefits: [
        "Revisa tu ensayo con confianza",
    ...
    },
    {
      ...
      title: "Corrección Potenciada por IA",
...
export default ProofreadingFeaturesES; 