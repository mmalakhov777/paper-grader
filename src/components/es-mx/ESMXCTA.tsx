      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 lg:mt-12 mb-12 lg:mb-[7.5rem]">
          <div className="flex md:grid md:grid-cols-3 md:gap-6 lg:gap-12 overflow-x-auto snap-x snap-mandatory scrollbar-hide pl-[20px] md:pl-0 -mr-4 md:mr-0">
            <div className="snap-start md:snap-none mr-4 md:mr-0">
              <Testimonial
                image="students1.png"
                quote="Me la pasaba reescribiendo el mismo párrafo una y otra vez. Esto por fin me mostró qué estaba mal. Mi estructura no funcionaba — la arreglé, ¡y mi calificación subió!"
                name="Sandra R."
            ...
            <div className="snap-start md:snap-none mr-4 md:mr-0">
              <Testimonial
                image="students2.png"
                quote="Lo usé la noche antes de mi entrega. Encontró puntos débiles que no vi, sobre todo en el flujo de argumentos. Hice algunos cambios y obtuve la calificación más alta del semestre"
                name="Diego M."
            ...
            <div className="snap-start md:snap-none">
              <Testimonial
                image="students3.png"
                quote="Honestamente, solo quería saber si mi ensayo estaba 'suficientemente bien'. Resultó que varias secciones necesitaban trabajo. Las correcciones fueron rápidas y me salvaron de entregar algo incompleto."
                name="Miguel S."
        ...
        <div className="text-center">
          ...
          <p className="text-[#3C3C3C] mb-6 lg:mb-10 text-base lg:text-[1.25rem] leading-normal lg:leading-[1.75rem]">
            Obtén feedback detallado y haz mejoras significativas — en minutos
          </p>
