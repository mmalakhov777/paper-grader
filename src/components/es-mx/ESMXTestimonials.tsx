...
const ESMXTestimonials: React.FC = () => {
  return (
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-12 lg:grid-cols-3 lg:w-[65%] w-full justify-items-start">
              <FeatureItem
                ...
                description="Obtén comentarios detallados para cada parte de tu trabajo"
              />
              <FeatureItem
                icon={<OneClickFixesIcon className="w-8 h-8" />}
                title="Buscador de citas"
                description="Enriquece tu trabajo con citas académicas en línea"
              />
              <FeatureItem
                icon={<CleanDraftIcon className="w-8 h-8" />}
                title="Correcciones con un clic"
                description="Aplica mejoras al instante directamente en el editor"
              />
            </div>
          </div>
...
export default ESMXTestimonials; 