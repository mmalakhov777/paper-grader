        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-24 items-start max-w-[1200px] mx-auto">
          ...
          <div className="relative">
            ...
            <div className="bg-white rounded-[20px] p-6 lg:p-8 shadow-sm border border-gray-100 relative z-10 mb-[-48px] lg:mb-0">
              ...
              <p className="text-[#9CA3AF] leading-relaxed text-base font-normal">
                Las redes sociales tienen un fuerte impacto en los adolescentes. Afectan su salud mental, autoestima y comportamiento. Muchos adolescentes pasan horas en línea todos los días, lo que puede provocar ansiedad y problemas de sueño. En general, las redes sociales dan forma a cómo los jóvenes se ven a sí mismos y al mundo que los rodea.
              </p>
            </div>
            ...
            <div className="bg-white rounded-[20px] p-6 lg:p-8 shadow-sm border border-gray-100 relative lg:absolute lg:top-[160px] lg:left-[40px] lg:right-[-40px] z-20">
              <h3 className="text-[#3C3C3C] text-base lg:text-xl font-normal mb-3 lg:mb-4">Después</h3>
              <p className="text-[#3C3C3C] leading-relaxed text-base font-normal">
                Las redes sociales tienen un fuerte impacto en los adolescentes. Afectan su salud mental, autoestima y comportamiento. <span className="bg-[#60A5FA]/20 rounded-[4px]">Según un estudio reciente, el uso excesivo diario está relacionado con mayor ansiedad y alteraciones en los patrones de sueño</span> <span className="text-[#60A5FA]">(López & García, 2021)</span>. En general, las redes sociales dan forma a cómo los jóvenes se ven a sí mismos y al mundo que los rodea.
              </p>
            </div>
          </div>
          ...
          <div className="lg:pl-16 mt-6 lg:mt-0">
            <h2 className="text-[2rem] lg:text-[3.25rem] font-medium leading-[1.2] lg:leading-[3.75rem] mb-6 lg:mb-8 text-[#232323]">
              Enriquece tu trabajo con citas en línea
            </h2>
            
            <div className="space-y-2 lg:space-y-[8px] mb-8">
              <div className="flex items-center gap-3">
                <Check className="w-5 h-5 lg:w-6 lg:h-6 text-[#232323]" />
                <span className="text-base lg:text-xl text-[#232323] font-medium">Identifica afirmaciones sin citar al instante</span>
              </div>
              <div className="flex items-center gap-3">
                <Check className="w-5 h-5 lg:w-6 lg:h-6 text-[#232323]" />
                <span className="text-base lg:text-xl text-[#232323] font-medium">Agrega fuentes confiables con un solo clic</span>
              </div>
              <div className="flex items-center gap-3">
                <Check className="w-5 h-5 lg:w-6 lg:h-6 text-[#232323]" />
                <span className="text-base lg:text-xl text-[#232323] font-medium">Dale más credibilidad a tus argumentos</span>
              </div>
            </div>
