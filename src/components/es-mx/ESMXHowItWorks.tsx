      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start mb-8 lg:mb-[2.5rem]">
          ...
          <p className="text-base lg:text-lg text-[#3C3C3C] lg:max-w-[17rem] lg:text-right">
            <span className="font-medium">3 pasos simples</span> para mejorar y completar tu trabajo académico
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-8">
          <StepCard
            ...
            description="Arrastra tu ensayo, reporte o tesis. Aceptamos todos los formatos académicos"
            isHighlighted={true}
          />
          
          <StepCard
            number={2}
            title="Recibe feedback al instante"
            description="La IA analiza tu trabajo según criterios académicos y señala lo que necesita mejoras"
          />
          
          <StepCard
            number={3}
            title="Corrige y entrega"
            description="Aplica mejoras con un clic y descarga una versión limpia lista para entregar"
          />
        </div>
      </div>
    </section>
