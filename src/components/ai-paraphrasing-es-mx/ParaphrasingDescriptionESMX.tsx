...
const ParaphrasingDescriptionESMX: React.FC = () => {
  const benefits = [
    {
      icon: <Shield className="w-6 h-6 text-[#232323]" />,
      title: "Mejor Parafraseador",
      description: "La mejor herramienta de parafraseo con IA para transformación natural de textos de cualquier tipo"
    },
    {
    ...
    },
    {
      ...
      title: "Herramienta Anti-Detección",
      description: "Herramienta de parafraseo que Turnitin no puede detectar, asegurando la originalidad de tus trabajos"
    },
    {
      icon: <AlertCircle className="w-6 h-6 text-[#232323]" />,
      title: "Bot de Parafraseo",
      description: "La mejor herramienta de parafraseo de IA para ensayos, tareas y trabajos académicos"
    }
  ];
...
export default ParaphrasingDescriptionESMX; 